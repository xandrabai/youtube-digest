...
- Save polished timestamped notes for later study, plus your own thought on each one.
...
- Attach your own thought to any note, from the player, a quote, selected transcript text, or the Notes tab itself, saved automatically on blur.
...
6. Save a note from the player or a key quote, then revisit it from **Notes** and add your own thought to it.
